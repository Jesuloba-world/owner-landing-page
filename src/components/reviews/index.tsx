...
export const Reviews = () => {
	return (
		<section className="flex flex-col py-[160px] bg-gradient-to-b from-white to-[#ebeae8]">
			<SectionWrapper>
				<div className="flex flex-col items-center justify-start gap-16">
					<div className="flex flex-col max-w-[600px] items-center justify-start text-center gap-6">
						<h4 className="font-medium leading-[1.1] tracking-[-0.018em] text-[44px]">
				...
				<div className="flex flex-col items-center self-center">
					<div className="flex pt-10 -mb-6 w-full gap-2">
